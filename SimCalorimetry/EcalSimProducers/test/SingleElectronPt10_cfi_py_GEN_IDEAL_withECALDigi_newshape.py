...
process.ecalConditions = cms.ESSource("PoolDBESSource", CondDBSetup,
      ...
      connect = cms.string('sqlite_file:/afs/cern.ch/user/d/dsoldi/work/CMS/newCMSEcalComplete/CMSSW_10_3_1/src/SimCalorimetry/EcalSimProducers/test/simPulseShapePhaseII.db'),
